<template>
  ...
  >
    ...
    <rect x="12" y="11" width="8" height="1" rx="0.5" fill="#016E7D" />
    <rect x="12" y="13" width="8" height="1" rx="0.5" fill="#016E7D" />
    <rect x="12" y="15" width="6" height="1" rx="0.5" fill="#016E7D" />
    <rect x="12" y="17" width="7" height="1" rx="0.5" fill="#016E7D" />
    <rect x="12" y="19" width="8" height="1" rx="0.5" fill="#016E7D" />
  </svg>
</template>

frappe.dom.set_style("/* sfc-style:/Users/netchampfaris/Projects/frappe-bench-suite/apps/drive/drive/public/js/FileUploader.vue?type=style&index=0 */\n.drive-picker[data-v-b349f0d7] {\n  display: flex;\n  flex-direction: column;\n  font-size: var(--text-base);\n  color: var(--ink-gray-8);\n}\n.drive-library-dialog .modal-body {\n  padding-top: 0.5rem;\n}\n.tab-bar[data-v-b349f0d7] {\n  display: flex;\n  gap: 0.25rem;\n  border-bottom: 1px solid var(--outline-gray-1, #e5e5e5);\n}\n.tab[data-v-b349f0d7] {\n  display: flex;\n  align-items: center;\n  gap: 0.4rem;\n  background: none;\n  border: none;\n  border-bottom: 1.5px solid transparent;\n  padding: 0.5rem 0.25rem;\n  margin-right: 0.75rem;\n  font-size: var(--text-sm);\n  color: var(--ink-gray-5);\n  cursor: pointer;\n}\n.tab.active[data-v-b349f0d7] {\n  color: var(--ink-gray-9);\n  border-bottom-color: var(--ink-gray-9);\n  font-weight: 500;\n}\n.tab-icon[data-v-b349f0d7] {\n  display: inline-flex;\n  width: 14px;\n  height: 14px;\n}\n.team-select-wrap[data-v-b349f0d7] {\n  position: relative;\n  margin-top: 0.75rem;\n}\n.team-select[data-v-b349f0d7] {\n  appearance: none;\n  width: 100%;\n  font-size: var(--text-sm);\n  height: 1.75rem;\n  border: 1px solid var(--outline-gray-2, #e0e0e0);\n  border-radius: var(--border-radius, 8px);\n  background: var(--surface-gray-2);\n  padding: 0 2rem 0 0.5rem;\n}\n.team-select-chevron[data-v-b349f0d7] {\n  position: absolute;\n  top: 50%;\n  right: 0.6rem;\n  display: inline-flex;\n  width: 14px;\n  height: 14px;\n  color: var(--ink-gray-7);\n  pointer-events: none;\n  transform: translateY(-50%);\n}\n.search[data-v-b349f0d7] {\n  margin-top: 0.75rem;\n  font-size: var(--text-sm);\n  height: 1.85rem;\n  border: 1px solid var(--outline-gray-2, #e0e0e0);\n  border-radius: var(--border-radius, 8px);\n  background: var(--surface-gray-2);\n  padding: 0 0.6rem;\n  width: 100%;\n}\n.search[data-v-b349f0d7]:focus {\n  outline: none;\n  background: var(--surface-white, #fff);\n  border-color: var(--outline-gray-3, #b3b3b3);\n}\n.crumbs[data-v-b349f0d7] {\n  display: flex;\n  align-items: center;\n  flex-wrap: nowrap;\n  overflow: hidden;\n  gap: 0.15rem;\n  padding: 0.6rem 0 0.4rem;\n}\n.crumb[data-v-b349f0d7] {\n  background: none;\n  border: none;\n  padding: 0.1rem 0.3rem;\n  border-radius: 6px;\n  font-size: var(--text-sm);\n  color: var(--ink-gray-5);\n  cursor: pointer;\n  white-space: nowrap;\n  max-width: 10rem;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.crumb[data-v-b349f0d7]:hover {\n  background: var(--surface-gray-2);\n}\n.crumb.last[data-v-b349f0d7] {\n  color: var(--ink-gray-8);\n  font-weight: 500;\n}\n.crumb-sep[data-v-b349f0d7] {\n  color: var(--ink-gray-4, #c4c4c4);\n  font-size: var(--text-sm);\n}\n.list[data-v-b349f0d7] {\n  height: 300px;\n  overflow-y: auto;\n  display: flex;\n  flex-direction: column;\n  gap: 1px;\n}\n.state[data-v-b349f0d7] {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  flex: 1;\n}\n.muted[data-v-b349f0d7] {\n  color: var(--ink-gray-5);\n  font-size: var(--text-sm);\n}\n.file-row[data-v-b349f0d7] {\n  display: flex;\n  align-items: center;\n  gap: 0.6rem;\n  width: 100%;\n  text-align: left;\n  background: none;\n  border: none;\n  margin: 0;\n  padding: 0.4rem 0.5rem;\n  border-radius: var(--border-radius, 8px);\n  cursor: pointer;\n  color: var(--ink-gray-8);\n}\n.file-row[data-v-b349f0d7]:hover {\n  background: var(--surface-gray-2);\n}\n.file-row.selected[data-v-b349f0d7] {\n  background: var(--surface-gray-3);\n}\n.row-icon[data-v-b349f0d7] {\n  width: 18px;\n  height: 18px;\n  flex-shrink: 0;\n  object-fit: contain;\n}\n.row-name[data-v-b349f0d7] {\n  flex: 1;\n  font-size: var(--text-base);\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.row-chevron[data-v-b349f0d7] {\n  width: 14px;\n  height: 14px;\n  color: var(--ink-gray-4, #c4c4c4);\n  flex-shrink: 0;\n  display: inline-flex;\n}\n.footer[data-v-b349f0d7] {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n  border-top: 1px solid var(--outline-gray-1, #e5e5e5);\n  padding-top: 0.75rem;\n  margin-top: 0.25rem;\n}\n.footer-info[data-v-b349f0d7] {\n  flex: 1;\n  font-size: var(--text-sm);\n  color: var(--ink-gray-5);\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n.footer-info b[data-v-b349f0d7] {\n  color: var(--ink-gray-8);\n  font-weight: 500;\n}\n.hidden[data-v-b349f0d7] {\n  display: none;\n}\n.ghost-btn[data-v-b349f0d7],\n.primary-btn[data-v-b349f0d7] {\n  font-size: var(--text-sm);\n  height: 1.75rem;\n  padding: 0 0.75rem;\n  border-radius: var(--border-radius, 8px);\n  border: none;\n  cursor: pointer;\n  display: inline-flex;\n  align-items: center;\n  gap: 0.35rem;\n}\n.ghost-btn[data-v-b349f0d7] {\n  background: var(--surface-gray-2);\n  color: var(--ink-gray-8);\n}\n.ghost-btn[data-v-b349f0d7]:hover {\n  background: var(--surface-gray-3);\n}\n.primary-btn[data-v-b349f0d7] {\n  background: var(--surface-gray-7, #383838);\n  color: var(--ink-white, #fff);\n}\n.primary-btn[data-v-b349f0d7]:disabled {\n  opacity: 0.4;\n  cursor: not-allowed;\n}\n/*# sourceMappingURL=ff_integration.bundle.V5NKTFMA.css.map */\n");
(() => {
      ...
      function setRef(rawRef, oldRawRef, parentSuspense, vnode, isUnmount = false) {
        ...
        if (shared.isFunction(ref2)) {
          ...
          if (_isString || _isRef) {
            const doSet = () => {
              if (rawRef.f) {
                const existing = _isString ? shared.hasOwn(setupState, ref2) ? setupState[ref2] : refs[ref2] : ref2.value;
                if (isUnmount) {
...
Component that was made reactive: `,
  ...
  var require_runtime_dom_cjs = __commonJS({
    "node_modules/@vue/runtime-dom/dist/runtime-dom.cjs.js"(exports) {
      ...
      var vShowOldKey = /* @__PURE__ */ Symbol("_vod");
      var vShow = {
...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-sfc`;
  ...
  // sfc-script:/Users/netchampfaris/Projects/frappe-bench-suite/apps/drive/drive/public/js/FileUploader.vue?type=script
  var chevronIcon = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>';
  var selectChevronIcon = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>';
  var SITE_TEAM = "__site";
  var PAGE = 50;
  var ICON_BASE = "/assets/drive/images/icons";
  var FileUploader_default = {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const tab = (0, vue_runtime_esm_bundler_exports.ref)("home");
      const rows = (0, vue_runtime_esm_bundler_exports.ref)([]);
      const loading = (0, vue_runtime_esm_bundler_exports.ref)(false);
      const loadingMore = (0, vue_runtime_esm_bundler_exports.ref)(false);
      const selected = (0, vue_runtime_esm_bundler_exports.ref)(null);
      const staged = (0, vue_runtime_esm_bundler_exports.ref)(null);
      const busy = (0, vue_runtime_esm_bundler_exports.ref)(false);
      const fileInput = (0, vue_runtime_esm_bundler_exports.ref)(null);
      const listEl = (0, vue_runtime_esm_bundler_exports.ref)(null);
      const teams = (0, vue_runtime_esm_bundler_exports.ref)([]);
      const team = (0, vue_runtime_esm_bundler_exports.ref)("");
      let personalTeam = "";
      const start = (0, vue_runtime_esm_bundler_exports.ref)(0);
      const hasMore = (0, vue_runtime_esm_bundler_exports.ref)(false);
      const searchText = (0, vue_runtime_esm_bundler_exports.ref)("");
      const searching = (0, vue_runtime_esm_bundler_exports.computed)(() => searchText.value.trim().length >= 2);
      const crumbs = (0, vue_runtime_esm_bundler_exports.ref)([{ name: "", label: __("Home") }]);
      const here = (0, vue_runtime_esm_bundler_exports.computed)(() => crumbs.value[crumbs.value.length - 1]);
      const canUpload = (0, vue_runtime_esm_bundler_exports.computed)(() => true);
      const ready = (0, vue_runtime_esm_bundler_exports.computed)(() => staged.value ? canUpload.value : !!selected.value);
      const isSiteTeam = (0, vue_runtime_esm_bundler_exports.computed)(() => tab.value === "teams" && team.value === SITE_TEAM);
      ...
      const sortRows = (items) => items.slice().sort((a, b) => Number(b.is_folder) - Number(a.is_folder));
      async function fetchPage(offset) {
        ...
        if (isSiteTeam.value) {
          if (q) {
            ...
            const r3 = await frappe.call("frappe.core.api.file.get_files_by_search_text", { text: q });
            return { items: r3.message || [], more: false };
          }
          const r2 = await frappe.call("frappe.core.api.file.get_files_in_folder", {
            folder: here.value.name || "Home",
            start: offset,
            page_length: PAGE
          });
          return { items: ((_a = r2.message) == null ? void 0 : _a.files) || [], more: !!((_b = r2.message) == null ? void 0 : _b.has_more) };
        }
        ...
        const raw = r.message || [];
        return { items: raw.filter((f) => {
          var _a2;
          return !((_a2 = f.file_name) == null ? void 0 : _a2.startsWith("."));
        }), more: raw.length === PAGE };
      }
      let searchTimer = null;
      (0, vue_runtime_esm_bundler_exports.watch)(searchText, () => {
      ...
      function throwUploadError(data, fallback) {
        const msgs = JSON.parse((data == null ? void 0 : data._server_messages) || "[]");
        throw new Error(msgs.length ? JSON.parse(msgs[0]).message : fallback);
      }
      __expose({ submit });
      const __returned__ = { chevronIcon, selectChevronIcon, props, tabs, SITE_TEAM, tab, rows, loading, loadingMore, selected, staged, busy, fileInput, listEl, teams, team, get personalTeam() {
        return personalTeam;
      }, set personalTeam(v) {
        personalTeam = v;
      }, PAGE, start, hasMore, searchText, searching, crumbs, here, canUpload, ready, isSiteTeam, rootCrumb, switchTab, selectTeam, openFolder, goTo, onRow, onStage, reload, loadMore, onScroll, topUp, sortRows, fetchPage, get searchTimer() {
        return searchTimer;
      }, set searchTimer(v) {
        searchTimer = v;
      }, ICON_BASE, UNKNOWN_ICON, EXT_ICON, iconUrl, submit, attach, siteUpload, driveUpload, throwUploadError, ref: vue_runtime_esm_bundler_exports.ref, computed: vue_runtime_esm_bundler_exports.computed, onMounted: vue_runtime_esm_bundler_exports.onMounted, watch: vue_runtime_esm_bundler_exports.watch };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  };

  // sfc-template:/Users/netchampfaris/Projects/frappe-bench-suite/apps/drive/drive/public/js/FileUploader.vue?type=template
  var _withScopeId = (n) => ((0, vue_runtime_esm_bundler_exports.pushScopeId)("data-v-b349f0d7"), n = n(), (0, vue_runtime_esm_bundler_exports.popScopeId)(), n);
  var _hoisted_1 = { class: "drive-picker" };
  var _hoisted_2 = { class: "tab-bar" };
  var _hoisted_3 = ["onClick"];
  var _hoisted_4 = ["innerHTML"];
  var _hoisted_5 = {
    key: 0,
    class: "team-select-wrap"
  };
  ...
  var _hoisted_14 = { class: "crumb last" };
  var _hoisted_15 = {
    key: 0,
    class: "state"
  };
  var _hoisted_16 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ (0, vue_runtime_esm_bundler_exports.createElementVNode)(
    "span",
  ...
  var _hoisted_19 = ["onClick", "onDblclick"];
  var _hoisted_20 = ["src"];
  ...
  var _hoisted_23 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ (0, vue_runtime_esm_bundler_exports.createElementVNode)(
    "span",
    { class: "spinner-border spinner-border-sm" },
    null,
    -1
  ...
  var _hoisted_25 = { class: "footer" };
  var _hoisted_26 = { class: "footer-info" };
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_1, [
      (0, vue_runtime_esm_bundler_exports.createCommentVNode)(" Tabs: Home (personal Drive) / Teams (including Site pseudo-team) "),
      (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_2, [
        ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)(
          vue_runtime_esm_bundler_exports.Fragment,
          null,
          (0, vue_runtime_esm_bundler_exports.renderList)($setup.tabs, (t) => {
            return (0, vue_runtime_esm_bundler_exports.createElementVNode)("button", {
              key: t.key,
              class: (0, vue_runtime_esm_bundler_exports.normalizeClass)(["tab", { active: $setup.tab === t.key }]),
              onClick: ($event) => $setup.switchTab(t.key)
            }, [
              (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", {
                class: "tab-icon",
                innerHTML: t.icon
              }, null, 8, _hoisted_4),
              (0, vue_runtime_esm_bundler_exports.createTextVNode)(
                " " + (0, vue_runtime_esm_bundler_exports.toDisplayString)(t.label),
                1
                /* TEXT */
              )
            ], 10, _hoisted_3);
      ...
      (0, vue_runtime_esm_bundler_exports.createCommentVNode)(" Team selector (Teams tab only; Site is a pseudo-team) "),
      $setup.tab === "teams" ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_5, [
        (0, vue_runtime_esm_bundler_exports.createElementVNode)("select", {
          class: "team-select",
          value: $setup.team,
          onChange: _cache[0] || (_cache[0] = ($event) => $setup.selectTeam($event.target.value))
        }, [
          (0, vue_runtime_esm_bundler_exports.createElementVNode)(
            "option",
            _hoisted_7,
            (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Select a team")),
            1
            /* TEXT */
          ),
          ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(
            vue_runtime_esm_bundler_exports.Fragment,
            null,
            (0, vue_runtime_esm_bundler_exports.renderList)($setup.teams, (t) => {
              return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("option", {
                key: t.name,
                value: t.name
              }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(t.title), 9, _hoisted_8);
            }),
            128
            /* KEYED_FRAGMENT */
          ))
        ...
        (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", {
          class: "team-select-chevron",
          innerHTML: $setup.selectChevronIcon
        })
      ])) : (0, vue_runtime_esm_bundler_exports.createCommentVNode)("v-if", true),
      (0, vue_runtime_esm_bundler_exports.createCommentVNode)(" Search "),
      (0, vue_runtime_esm_bundler_exports.withDirectives)((0, vue_runtime_esm_bundler_exports.createElementVNode)("input", {
        ...
        [vue_runtime_esm_bundler_exports.vModelText, $setup.searchText]
      ]),
      (0, vue_runtime_esm_bundler_exports.createCommentVNode)(" Breadcrumbs (hidden while searching) "),
      !$setup.searching ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_10, [
        ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(
          vue_runtime_esm_bundler_exports.Fragment,
          null,
          (0, vue_runtime_esm_bundler_exports.renderList)($setup.crumbs, (c, i) => {
            return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)(
              vue_runtime_esm_bundler_exports.Fragment,
              {
                key: c.name
              },
              [
                (0, vue_runtime_esm_bundler_exports.createElementVNode)("button", {
                  class: (0, vue_runtime_esm_bundler_exports.normalizeClass)(["crumb", { last: i === $setup.crumbs.length - 1 }]),
                  onClick: ($event) => $setup.goTo(i)
                }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(c.label), 11, _hoisted_11),
                i < $setup.crumbs.length - 1 ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("span", _hoisted_12, "/")) : (0, vue_runtime_esm_bundler_exports.createCommentVNode)("v-if", true)
              ],
              64
              /* STABLE_FRAGMENT */
            );
      ...
      ])) : ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_13, [
        (0, vue_runtime_esm_bundler_exports.createElementVNode)(
          "span",
          _hoisted_14,
          (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Search results")),
          1
          /* TEXT */
        )
      ])),
      (0, vue_runtime_esm_bundler_exports.createCommentVNode)(" List "),
      (0, vue_runtime_esm_bundler_exports.createElementVNode)(
        "div",
        {
          ref: "listEl",
        ...
        [
          $setup.loading ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_15, [..._hoisted_17])) : !$setup.rows.length ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)(
            "div",
            _hoisted_18,
            (0, vue_runtime_esm_bundler_exports.toDisplayString)($setup.searching ? _ctx.__("No matches") : _ctx.__("Empty folder")),
            1
            /* TEXT */
          )) : (0, vue_runtime_esm_bundler_exports.createCommentVNode)("v-if", true),
          ((0, vue_runtime_esm_bundler_exports.openBlock)(true), (0, vue_runtime_esm_bundler_exports.createElementBlock)(
            vue_runtime_esm_bundler_exports.Fragment,
            null,
            (0, vue_runtime_esm_bundler_exports.renderList)($setup.rows, (row) => {
              return (0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("button", {
                key: row.name,
                class: (0, vue_runtime_esm_bundler_exports.normalizeClass)(["file-row", { selected: $setup.selected && $setup.selected.name === row.name }]),
                onClick: ($event) => $setup.onRow(row),
                onDblclick: ($event) => row.is_folder && $setup.openFolder(row)
              }, [
                (0, vue_runtime_esm_bundler_exports.createElementVNode)("img", {
                  class: "row-icon",
                  src: $setup.iconUrl(row),
                  onError: _cache[2] || (_cache[2] = ($event) => $event.target.src = $setup.UNKNOWN_ICON)
                }, null, 40, _hoisted_20),
                (0, vue_runtime_esm_bundler_exports.createElementVNode)("span", {
                  class: "row-name",
                  title: row.file_name
                }, (0, vue_runtime_esm_bundler_exports.toDisplayString)(row.file_name), 9, _hoisted_21),
                row.is_folder ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("span", {
                  key: 0,
                  class: "row-chevron",
                  innerHTML: $setup.chevronIcon
                })) : (0, vue_runtime_esm_bundler_exports.createCommentVNode)("v-if", true)
              ], 42, _hoisted_19);
            }),
            128
          ...
          $setup.loadingMore ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("div", _hoisted_22, [..._hoisted_24])) : (0, vue_runtime_esm_bundler_exports.createCommentVNode)("v-if", true)
        ],
        544
        /* NEED_HYDRATION, NEED_PATCH */
      ),
      (0, vue_runtime_esm_bundler_exports.createCommentVNode)(" Footer "),
      (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_25, [
        (0, vue_runtime_esm_bundler_exports.createElementVNode)("div", _hoisted_26, [
          $setup.staged ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)(
            vue_runtime_esm_bundler_exports.Fragment,
            { key: 0 },
            [
              (0, vue_runtime_esm_bundler_exports.createTextVNode)(
                (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Upload")) + " ",
                1
                /* TEXT */
              ),
              (0, vue_runtime_esm_bundler_exports.createElementVNode)(
                "b",
                null,
                (0, vue_runtime_esm_bundler_exports.toDisplayString)($setup.staged.name),
                1
                /* TEXT */
              ),
              (0, vue_runtime_esm_bundler_exports.createTextVNode)(
                " " + (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("to")) + " ",
                1
                /* TEXT */
              ),
              (0, vue_runtime_esm_bundler_exports.createElementVNode)(
                "b",
                null,
                (0, vue_runtime_esm_bundler_exports.toDisplayString)($setup.here.label),
                1
                /* TEXT */
              )
            ],
            64
            /* STABLE_FRAGMENT */
          )) : $setup.selected ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)(
            "b",
            _hoisted_27,
            (0, vue_runtime_esm_bundler_exports.toDisplayString)($setup.selected.file_name),
            1
            /* TEXT */
          )) : $setup.canUpload ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)(
            vue_runtime_esm_bundler_exports.Fragment,
            { key: 2 },
            [
              (0, vue_runtime_esm_bundler_exports.createTextVNode)(
                (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Choose a file, or open a folder")),
                1
                /* TEXT */
              )
            ],
            ...
            [
              (0, vue_runtime_esm_bundler_exports.createTextVNode)(
                (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Choose a file to attach")),
                1
                /* TEXT */
              )
            ],
        ...
        $setup.canUpload ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)(
          ...
          (0, vue_runtime_esm_bundler_exports.toDisplayString)(_ctx.__("Upload new")),
          1
          /* TEXT */
        )) : (0, vue_runtime_esm_bundler_exports.createCommentVNode)("v-if", true),
        (0, vue_runtime_esm_bundler_exports.createElementVNode)("button", {
          class: "primary-btn",
          disabled: !$setup.ready || $setup.busy,
          onClick: $setup.submit
        }, [
          $setup.busy ? ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)("span", _hoisted_29)) : ((0, vue_runtime_esm_bundler_exports.openBlock)(), (0, vue_runtime_esm_bundler_exports.createElementBlock)(
            vue_runtime_esm_bundler_exports.Fragment,
            { key: 1 },
            [
              (0, vue_runtime_esm_bundler_exports.createTextVNode)(
                (0, vue_runtime_esm_bundler_exports.toDisplayString)($setup.staged ? _ctx.__("Upload & attach") : _ctx.__("Attach")),
                1
                /* TEXT */
              )
            ],
  ...
  // ../drive/drive/public/js/FileUploader.vue
  FileUploader_default.render = render;
  FileUploader_default.__file = "../drive/drive/public/js/FileUploader.vue";
  FileUploader_default.__scopeId = "data-v-b349f0d7";
  var FileUploader_default2 = FileUploader_default;

  // ../drive/drive/public/js/ff_integration.bundle.js
  var LIBRARY_ICON = '<circle cx="15" cy="15" r="15" fill="var(--subtle-fg)" /><path d="M13.0245 11.5H8C7.72386 11.5 7.5 11.7239 7.5 12V20C7.5 21.1046 8.39543 22 9.5 22H20.5C21.6046 22 22.5 21.1046 22.5 20V14.5C22.5 14.2239 22.2761 14 22 14H15.2169C15.0492 14 14.8926 13.9159 14.8 13.776L13.4414 11.724C13.3488 11.5841 13.1922 11.5 13.0245 11.5Z" fill="none" stroke="var(--text-color)" stroke-miterlimit="10" stroke-linecap="square" /><path d="M8.87939 9.5V8.5C8.87939 8.22386 9.10325 8 9.37939 8H20.6208C20.8969 8 21.1208 8.22386 21.1208 8.5V12" fill="none" stroke="var(--text-color)" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />';
  var LIBRARY_UPLOADER = {
    label: __("Library"),
    icon: LIBRARY_ICON,
    action: async ({ dialog, uploader }) => {
      ...
      const app = (0, vue_runtime_esm_bundler_exports.createApp)(FileUploader_default2, {
        uploader,
        onComplete: () => d.hide()
      });
      SetVueGlobals(app);
  ...
  (async () => {
    ...
    class DriveFileUploader extends Original {
      constructor(opts = {}) {
        if (opts.disable_file_browser === void 0) {
...
@vue/runtime-dom/dist/runtime-dom.cjs.js:
  (*! #__NO_SIDE_EFFECTS__ *)
*/
//# sourceMappingURL=ff_integration.bundle.KXJU6URJ.js.map

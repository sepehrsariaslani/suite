...
from suite.www.suite import get_boot


class IntegrationTestSuiteWww(IntegrationTestCase):
	def test_get_boot_exposes_push_relay_url(self):
		boot = get_boot()
		self.assertIn("push_relay_server_url", boot)

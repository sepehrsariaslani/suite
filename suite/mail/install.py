...
def add_rate_limits() -> None:
	...
	rate_limits = [
		...
		{"method_path": "suite.mail.api.outbound.send", "key": "priority", "value": "Low", "limit": 100, "seconds": 60},
		{"method_path": "suite.mail.api.outbound.send", "key": "priority", "value": "Normal", "limit": 50, "seconds": 60},
		{"method_path": "suite.mail.api.outbound.send", "key": "priority", "value": "High", "limit": 10, "seconds": 60},
		{"method_path": "suite.mail.api.outbound.send_raw", "key": "priority", "value": "Low", "limit": 100, "seconds": 60},
		{"method_path": "suite.mail.api.outbound.send_raw", "key": "priority", "value": "Normal", "limit": 50, "seconds": 60},
		{"method_path": "suite.mail.api.outbound.send_raw", "key": "priority", "value": "High", "limit": 10, "seconds": 60},

...
from mail.utils.cache import get_cluster_for_domain
		...
		if self.enabled:
			if self.has_value_changed("enabled"):
				...
				create_dkim_key_on_cluster(
					get_cluster_for_domain(self.domain_name),
					self.domain_name,
					self.get_password("rsa_private_key"),
				)
		elif self.has_value_changed("enabled"):
			delete_dkim_key_from_cluster(get_cluster_for_domain(self.domain_name), self.domain_name)

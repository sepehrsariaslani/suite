...
frappe.ui.form.on('Mail Message', {
	...
	add_reply_forward_buttons(frm) {
		...
		add_mapped_button('Reply', 'suite.mail.doctype.mail_message.mail_message.reply')
		add_mapped_button('Reply All', 'suite.mail.doctype.mail_message.mail_message.reply_all')
		add_mapped_button('Forward', 'suite.mail.doctype.mail_message.mail_message.forward')
	},
